...
```http
GET [https://raw.githubusercontent.com/TU_USUARIO/TU_REPO/main/tasas_cambio.json](https://raw.githubusercontent.com/TU_USUARIO/TU_REPO/main/tasas_cambio.json)
